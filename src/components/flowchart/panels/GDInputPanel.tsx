        ...
        <div className="flex items-center justify-between py-1">
          ...
          <button
            ...
            className={`relative w-12 h-7 rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-brand-primary/50 ${
              value ? 'bg-brand-primary' : 'bg-gray-600'
            }`}
          >
            <span
              className={`absolute top-1 w-5 h-5 rounded-full shadow-md transition-transform ${
                value ? 'translate-x-6 bg-white' : 'translate-x-1 bg-gray-300'
              }`}
            />
          </button>
        </div>
