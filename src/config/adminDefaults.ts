...
// Default tabs (current configuration) - Shop, Home, Leaderboard
export const defaultTabs: TabConfig[] = [
  { id: 'shop', icon: '/icons/Shopping-2.svg', label: 'Shop', page: 'shop', enabled: true },
...
// Default enabled events (beat blitz, stage showdown, melody quest, rhythm pass and clef-collection for progress bar)
export const defaultEnabledEvents: string[] = ['sky-race', 'lava-quest', 'mission-control', 'royal-pass', 'clef-collection'];

// Default event placement (beat blitz & stage showdown on left, melody quest and rhythm pass on right)
export const defaultEventPlacement: EventPlacement = {
  left: ['sky-race', 'lava-quest'],
